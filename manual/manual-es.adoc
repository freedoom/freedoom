...
* Intenta moverte hacia delante, hacia atrás, a la izquierda y a la derecha.
  Intenta hacer un ocho. (No salgas de la jaula todavía: hay monstruos fuera.)
...
* Intenta hacer un ocho mientras apuntas a la columna todo el tiempo.
  Prioriza la suavidad sobre la precisión: es mejor estar cerca la mayor
  parte del tiempo que ser perfecto algunas veces.
...
* Mantenga presionada la tecla Correr (o habilite "Corre siempre" en sus
  opciones) y vea si aún puede hacer todo con suficiente precisión.
...
este momento (por ejemplo, no puedes recoger un paquete de salud cuando
...
* ¡No aplastes los botones! Casi todas las armas tienen un ligero período de
  ...
  presionado Fuego te permitirá disparar cualquier arma continuamente
