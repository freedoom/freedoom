...
Para jugar al juego, puedes usar DOOM.EXE, pero probablemente será más fácil
utilizar un "source port" - una de las muchas adaptaciones del programa
original de Doom que los aficionados han hecho para los sistemas modernos.
...
* https://zdoom.org[GZDoom] es un source port moderno que incluye renderización
...
el más fácil). No hay ningún requerimiento para jugar los episodios en orden.
...
recordar para la partida guardada (p. ej., “E1M3 - Puerta con llave azul”) y
...
3 | El sistema de ocultación de destellos más sencillo garantiza una mejor
fragmentación del proyectil, para casi un 50% más de impactos por cartucho
a través de una dispersión más amplia. Es buena a corto alcance contra grupos de
...
hace una gran cantidad de daño, y suelta una explosión secundaria de energía
...
|==========================
| 1% | 10% | 25% | 100%
| image:../sprites/bon1a0.png[Pólipo ectoplásmico] |
image:../sprites/stima0.png[Gasa regenerativa nanobot] |
image:../sprites/media0.png[Equipo quirúrgico regenerativa nanobot] |
...
|==========================
| 1% | 100% | 200%
| image:../sprites/bon2a0.png[Emisor de campos de energía polarica] |
...
daño. Como los emisores polarica dan el mismo tipo de armadura que ya tienes,
...
cuernos de la calavera: +
• las dos primeras letras de "Azul" tienen muchas líneas diagonales. +
• "Amarillo" tiene dos líneas verticales. +
• el planeta "Horizon" es muy rojo. +
