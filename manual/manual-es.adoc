...
On most source ports, if you repeatedly hit Enter after the program has started, you will end up starting a new game on the normal skill level.

En la mayoría de los source ports, si pulsas repetidamente _Enter_ después de que el
programa se haya iniciado, empezarás una nueva juego en el nivel de dificultad default
(en el primer episodio si jugares Phase 1).
