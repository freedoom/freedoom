...
lo encuentres más cómodo jugar. Practica moverte y disparar el arma.

En particular, tendrá que sentirse cómodo:

* mover hacia delante, hacia atrás, a la izquierda y a la derecha,
y cualquier combinación razonable de ellas.

* girar para apuntar con tu arma (el centro de la pantalla) a un objeto determinado.

* girar y apuntar a las cosas mientras te mueves en cada una de las direcciones.

* mirar algo, ponerse detrás de otra cosa y luego volver a la vista,
como cuando se juega al "Cucú" con un niño.

* mover a la izquierda mientras giras a la derecha, y viceversa, para estando
de cara a (y apuntando tu arma a) un punto en particular mientras te mueves.

* realizar cualquiera de estas acciones mientras se pulsa la tecla Disparo.

* realizar cualquiera de estas acciones mientras se pulsa la tecla Usar.

* realizar cualquiera de estas acciones mientras se pulsa la tecla Correr
(o está activada la opción "Corre siempre").

Luego ve y mata a un zombi. Trate de no ser golpeado.
...
<<health,salud>> o más <<armor,blindaje>>. También puedes encontrar
...
El Doom original no te permitía mirar hacia arriba o hacia abajo. Si
tienes un monstruo, un barril o un oponente PvP cruzando la línea central
de tu pantalla cuando tu arma se dispara, el juego ajustará tu puntería
vertical por ti. Algunos ports te permitirán desactivar este comportamiento
y ajustar la puntería vertical manualmente.
...
El color de una llave es siempre asociados con la dirección de su líneas
o cuernos: azul diagonal, amarillo vertical, rojo horizontal.
| **Gafas luminosas** +
