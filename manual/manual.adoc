...
when you save a game while too much is going on on the level. Chocolate
...
will open doors and activate switches. Check the settings on your source port
on how to rebind these keys to a setup that you find more comfortable.
You’ll also want to look into using the strafe (sidestep) and run keys to
...
In particular you will need to be comfortable:

* moving forward, backward, left, and right, and any reasonable combination of them.

* turning to point your weapon (the center of your screen) at a given object.

* turning and pointing at things while moving in each of the directions.

* looking at something, stepping behind something else, then stepping back
into view, like playing "Peek-A-Boo" with a child.

* moving left while turning right, and vice versa, so that you can keep facing
(and pointing your weapon at) a particular spot while moving about.

* doing any of these while the Fire key is pressed.

* doing any of these while tapping the Use key.

* doing any of these while the Run key is pressed (or "Always Run" is enabled).

Then go and kill a zombie. Try not to get hit.
...
The original Doom did not let you look up or down. If you have a monster, a
barrel or a PvP opponent crossing the middle line of your screen when your
weapon discharges, the game will adjust your vertical aim for you. Some source
ports will let you disable this behaviour and let you adjust vertical aim
manually instead.
...
The color of a key is always associated with the direction of a key's
lines or horns: blue diagonal, yellow vertical, red horizontal.
| **Low-Light Goggles** +
