...
On most source ports, if you repeatedly hit Enter after the program has
started, you will end up starting a new game on the normal skill level
(in the first episode if you're playing Phase 1).
