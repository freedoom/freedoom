...
| **Octaminator** |
These cybernetic abominations can fire powerful homing
missiles at you, or beat you to a bloody pulp in a melee. |
image:images/monster-octaminator.png[Octaminator,100,100]
| **Necromancer** |
