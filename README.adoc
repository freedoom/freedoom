...
The general rules go as follows:
  ...
  * Freedoom's name often leads some people to think that the project's
    goal is to make just a "free copy of Doom". This is not the case! While
    compatibility with Doom remains one of the main goals of the project, we are intending to build our own unique experience.
    Please make sure your work and efforts is original and distinct,
    and more than just a copy of Doom.
