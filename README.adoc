...
The general rules go as follows:
  ...
  * You must have permission for everything you submit.  If you make
    ...
    license.
  * Freedoom's name often leads some people to think that the project's goal is just to make a "free Doom clone". This is not the case!
    While compatibility with Doom is a goal, we are building our own game.
    Rather than trying to recreate anything from Doom, please focus your efforts in creating something fresh, new and distinct.
